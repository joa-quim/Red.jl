...
export
    ...
    redGet, redSet, redSetPath, redGetPath, redSetField, redGetField, redPrint, redProbe, redHasError, 
    redFormError, redOpenLogWindow, redCloseLogWindow, redOpenLogFile, redCloseLogFile,
